...
var cards, nCards, cover, openContent, openContentText, pageIsOpen = false,
    openContentImage, closeContent, windowWidth, windowHeight, currentCard, header, section, scrollPos, footer;
...
function animateCoverUp(card) {
    ...
    console.log(card.children[2].children[1].textContent); */
    openContentText.innerHTML = '<blockquote' + ' class="flow-text">' + card.children[2].children[0].textContent + '</blockquote>' + card.children[2].children[1].innerHTML;
    openContentImage.src = card.children[0].children[1].src;
    setTimeout(function () {
...
function setCoverColor(cardStyle) {
    ...
    cover.style.backgroundColor = "white"//cardStyle.backgroundColor;
    openContent.style.backgroundColor = cardStyle.backgroundColor;
}
